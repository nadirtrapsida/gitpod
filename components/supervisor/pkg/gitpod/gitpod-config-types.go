...
type Github struct {
	...
	Prebuilds interface{} `json:"prebuilds,omitempty"`
}
...
type GitpodConfig struct {
	...
	Ide interface{} `json:"ide,omitempty"`

	// The Docker image to run your workspace in.
	Image interface{} `json:"image,omitempty"`

	// List of exposed ports.
	Ports []*PortsItems `json:"ports,omitempty"`
	...
	Tasks []*TasksItems `json:"tasks,omitempty"`
